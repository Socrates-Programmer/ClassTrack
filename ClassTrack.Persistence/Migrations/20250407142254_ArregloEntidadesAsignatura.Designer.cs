...
namespace ClassTrack.Persistence.Migrations
{
    ...
    [Migration("20250407142254_ArregloEntidadesAsignatura")]
    partial class ArregloEntidadesAsignatura
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ClassTrack.Domain.Entities.Asignatura", b =>
                {
                    ...
                    b.Property<int?>("EquivalenciaAsignaturaId")
                        .HasColumnType("int");

                    b.Property<int?>("IncompatibilidadAsignaturaId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("EquivalenciaAsignaturaId");

                    b.HasIndex("IncompatibilidadAsignaturaId");
            ...
            modelBuilder.Entity("ClassTrack.Domain.Entities.Asignatura", b =>
                {
                    ...
                    b.HasOne("ClassTrack.Domain.Entities.EquivalenciaAsignatura", null)
                        .WithMany("Asignatura")
                        .HasForeignKey("EquivalenciaAsignaturaId");

                    b.HasOne("ClassTrack.Domain.Entities.IncompatibilidadAsignatura", null)
                        .WithMany("Asignatura")
                        .HasForeignKey("IncompatibilidadAsignaturaId");
